...
- Stocks (fiddle with connecting to a stock tracker that I can update via phone)
- TODO lists - would make my life a lot easier, but not as important
  - standard tasks in google tasks
  - lists in apple reminders (curious how this is going to work)
